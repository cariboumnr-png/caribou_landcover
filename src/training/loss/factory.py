...
class HeadLosses:
    ...
    def __init__(self, specs: dict[str, training.loss.CompositeLoss]):
        self._specs = specs

    def __getitem__(self, key: str) -> training.common.CompositeLossLike:
        return self._specs[key]

    def __len__(self) -> int:
        return len(self._specs)

    def as_dict(self) -> dict[str, training.common.CompositeLossLike]:
...
def build_headlosses(
    ...
    loss_dict: dict[str, training.loss.CompositeLoss] = {}
    ...
    for name in per_head_alphas.keys():
        ...
        loss_cls = training.loss.CompositeLoss(config, ignore_index)
...
sample_class = training.loss.CompositeLoss(sample_config, 255)
